...
<body>
    ...
    <div class="white-box">
        <?php
            ...
            // Insert Property Manager if provided
            ...
            // Insert House if provided
            if (!empty($_POST["fenced_yard"]) && !empty($_POST["detached_semi"])) {
                $fenced_yard = "'" . $_POST["fenced_yard"] . "'";
                $detached_semi = "'" . $_POST["detached_semi"] . "'";
                $sql = "insert into House values ($property_ID, $fenced_yard, $detached_semi);";
                if ($connection->query($sql) == TRUE) {
                    echo "<p>New house created successfully.</p>";
                } else {
                    echo "<p>Error: " . $sql . "<br>" . $connection->error . "</p>";
                }
            }
